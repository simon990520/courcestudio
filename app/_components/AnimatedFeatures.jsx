...
export default function AnimatedFeatures() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mt-10 md:mt-20 px-4 md:px-0">
      ...
      >
        <div className="bg-orange-100 w-10 md:w-12 h-10 md:h-12 rounded-lg mb-3 md:mb-4 flex items-center justify-center">
      ...
      <motion.div
        ...
        className="bg-white p-4 md:p-6 rounded-xl shadow-lg"
      >
        <div className="bg-yellow-100 w-10 md:w-12 h-10 md:h-12 rounded-lg mb-3 md:mb-4 flex items-center justify-center">
